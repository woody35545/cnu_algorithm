...
//	private PairOfPoints solveByHybirdRecursively(ReferenceList Px, ReferenceList Py) {

//	}
	/*
	 * public PairOfPoints solveByHybird(PointSet pointSetForSolve) { if
	 * (pointSetForSolve == null || pointSetForSolve.size() <= 1) { return null; }
	 * this.setPointSet(pointSetForSolve); ReferenceList Px = new
	 * ReferenceListOrderedByX(this.pointSet()); ReferenceList Py = new
	 * ReferenceListOrderedByY(this.pointSet());
	 * 
	 * PairOfPoints closestPair = this.(Px, Py); return closestPair; }
	 */
	...
	private int minRecursiveSize() {
		return this._minRecursionSize;
	}

	private void setMinRecursiveSize(int newMinRecursiveSize) {
